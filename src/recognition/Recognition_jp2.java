...
public class Recognition_jp2 extends Abstarct_Recognition{

	private String questionsName="quize.txt";

	public static Recognition_jp2 instance=null;
	 ...
	 * 
	 */
	public Recognition_jp2() {
		super("boot_jp.jconf", "localhost", 10501);
